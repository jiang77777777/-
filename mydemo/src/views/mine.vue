    ...
    <div class="bgc">
      ...
      <div class="userInfo" v-else>
        ...
        <van-image
          ...
          width="2.4rem"
          height="2.4rem"
          src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2160835127,365174925&fm=26&gp=0.jpg"
        />
        <!-- 姓名 -->
        <van-cell style="background-color:crimson" class="username">
          {{ userInfo.nickname }}
        </van-cell>
      ...
      <van-image  style="margin-bottom: 20px;width:100%"   src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1798548542,672372769&fm=26&gp=0.jpg">
